#-- Escribir un programa que pida un carácter al usuario y lo convierta a su número correspondiente. ç
#-- El carácter debe ser un dígito '0'-'9'. Si el usuario introduce un carácter diferente, 
#-- se imprimirá un mensaje de error y se volverá a pedir otro carácter
